...
public class Event implements Listener {
  ...
  public void onTotemUse(EntityResurrectEvent e) {
    if (e.getEntity() instanceof Player) {
      ...
      if (p.getInventory().getItemInMainHand().getType() == Material.TOTEM || p.getInventory().getItemInOffHand().getType() == Material.TOTEM)
        if (checkTotem(p.getInventory().getItemInOffHand()) || checkTotem(p.getInventory().getItemInMainHand())) {
          e.setCancelled(true);
          return;
        }  
    } 
